...
// Set VITE_API_URL in your .env file to your backend URL

const BASE_URL = import.meta.env.VITE_API_URL || "https://4smy2qfmw3.execute-api.us-east-1.amazonaws.com/prod";
